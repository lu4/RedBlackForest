...
{
    partial class RedBlackTree<TKey>
    {
        /// <summary>
        ...
        private static Boolean IsRed(RedBlackTreeNode<TKey> node)
        {
            if (null == node)
            {
        ...
        /// </summary>
        /// <param name="node">Specified node.</param>
        private static void FlipColor(RedBlackTreeNode<TKey> node)
        {
        ...
        private static RedBlackTreeNode<TKey> RotateLeft(RedBlackTreeNode<TKey> node)
        {
        ...
        /// <param name="node">Specified node.</param>
        /// <returns>New root node.</returns>
        private static RedBlackTreeNode<TKey> RotateRight(RedBlackTreeNode<TKey> node)
        {
        ...
        /// <returns>New root node.</returns>
        private static RedBlackTreeNode<TKey> MoveRedLeft(RedBlackTreeNode<TKey> node)
        {
            FlipColor(node);
        ...
        /// <param name="node">Parent node.</param>
        /// <returns>New root node.</returns>
        private static RedBlackTreeNode<TKey> MoveRedRight(RedBlackTreeNode<TKey> node)
        {
            FlipColor(node);
        ...
        /// <param name="node">Specified node.</param>
        /// <returns>New root node.</returns>
        private static RedBlackTreeNode<TKey> DeleteMinimum(RedBlackTreeNode<TKey> node)
        {
            if (null == node.Left)
            {
                // Nothing to do
        ...
        /// <param name="node">Specified node.</param>
        /// <returns>New root node.</returns>
        private static RedBlackTreeNode<TKey> FixUp(RedBlackTreeNode<TKey> node)
        {
            if (IsRed(node.Right))
            {
        ...
        private static RedBlackTreeNode<TKey> GetMinimumNode(RedBlackTreeNode<TKey> node)
        {
            if (node != null)
            {
                // Initialize
        ...
        private static RedBlackTreeNode<TKey> GetMaximumNode(RedBlackTreeNode<TKey> node)
        {
            if (node != null)
            {
                // Initialize
